...
Class.prototype.render = function() {
  ...
  if (/^#/.test(options.theme)) {
    var style = lay.elem("style"),
      styleText = ["#{{id}} .layui-laydate-header{background-color:{{theme}};}", "#{{id}} .layui-this{background-color:{{theme}} !important;}"]
        .join("")
...
Class.prototype.calendar = function(value) {
  ...
  if (options.lang === "cn") {
    ...
    lay(elemYM[0])
      .attr("lay-type", "month")
      .html(lang.month[dateTime.month])
    lay(elemYM[1])
      .attr("lay-type", "year")
      .html(dateTime.year)
  }
